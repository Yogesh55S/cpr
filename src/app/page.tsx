...
export default function HomePage() {
  ...
  return (
    <ClientLayout>
      ...
      {/* ===== CUSTOMER REVIEWS ===== */}
      <section className="relative py-20 md:py-28 overflow-hidden bg-ivory">
        {/* decorative blobs */}
        ...
        <div className="relative z-10 max-w-[1280px] mx-auto px-4 sm:px-5 md:px-8 mb-10">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6 mb-12 md:mb-14">
            ...
            {/* Rating summary */}
            <div className="shrink-0 flex items-center gap-4 bg-white rounded-2xl shadow-card border border-slate-100 px-5 py-4">
